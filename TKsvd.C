...
void TKsingularValueDecomposition_lsq(long double **designMatrix,int n,int nf,long double **v,long double *w,long double **u)
{
   long double an;
...
void TKbidiagonal(long double **a,long double *an,int ndata,int nfit,long double **v,long double *w,long double **u,long double *rv1)
{
   int i,j,k,l;
   long double g=0.0;
   long double scale=0.0,s,f,h;
...
/*                                                                       */
/* Returns 'x'                                                           */
void TKbacksubstitution_svd(long double **V, long double *w,long double **U,long double *b,long double *x,int n,int nf)
{
   int i,j;
   long double uTb[nf];
...
long double TKpythag(long double a,long double b)
{
   long double ret=0.0;
